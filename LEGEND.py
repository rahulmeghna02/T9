...
# Configuration
TOKEN = "8112795608:AAGVJMRik8S9XU2C5Ho2SLzIwSwXeGWHphs"  # Replace with your Telegram bot token
ADMIN_IDS = {1661744209}  # Replace with your actual admin user ID(s)

# MongoDB setup
mongo_client = pymongo.MongoClient("mongodb+srv://Kamisama:Kamisama@kamisama.m6kon.mongodb.net")
db = mongo_client["kamisama"]
